...
* Use one or more Census measurements: `vignette("determine-measurement")`
* Describe who or what has been measured: `vignette("determine-demographies")`
* Specify where the measurements were made: `vignette("determine-geographies")`
* Choose the year(s) that are relevant: `vignette("determine-timeframes")`
