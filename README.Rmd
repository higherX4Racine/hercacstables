...
However, it will work for pulling data from any dataset in the [Census API](https://api.census.gov/data.html).
A great resource for understanding the complexities of Census data is
...
census for some specific level of geography.
