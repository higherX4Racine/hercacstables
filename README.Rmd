...
```{r}
#| label: show-populations
#| echo: false
knitr::kable(POPS_AND_HOUSEHOLDS)
```
...
* Use one or more Census measurements: `vignette("determine_measurement")`
* Describe who or what has been measured: `vignette("determine_demographies")`
* Specify where the measurements were made: `vignette("determine_geographies")`
* Choose the year(s) that are relevant: `vignette("determine_timeframes")`
