...
With `hercacstables`, you would search within its glossary about ACS
groups:
...
There `hercacstables` also provides glossary about variables. You can
...
[`hercacstables::unpack_group_details()`](https://higherx4racine.github.io/hercacstables/reference/unpack_group_details.md)
to do this, in combination with tools from the
