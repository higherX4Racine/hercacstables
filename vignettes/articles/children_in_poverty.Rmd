...
The `hercacstables` package provides a table, `GLOSSARY_OF_STANDARD_OF_LIVING`,
...
The `hercacstables` package has a table, `GLOSSARY_OF_FAMILIES_WITH_CHILDREN`, that
...
The `hercacstables` package's table `GLOSSARY_OF_CHILDREN_IN_POVERTY` describes how
