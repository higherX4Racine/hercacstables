---
title: "Population changes in school districts"
---
...
`hercacstables::GLOSSARY_OF_ACS_GROUPS` and `hercacstables::GLOSSARY_OF_ACS_VARIABLES`.
...
school_district_geographies <- hercacstables::GLOSSARY_OF_ACS_GEOGRAPHIES |>
