---
title: "pop-changes-in-big-oh-districts"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{pop-changes-in-big-oh-districts}
...
`hercacstables::ACS_GROUP_METADATA` and `hercacstables::ACS_VARIABLE_METADATA`.
...
school_district_geographies <- hercacstables::ACS_GEOGRAPHY_METADATA |>
